module.exports = {
    friendlyName: "Returns a node from model EthereumNode to be used for reading blockchain data",
    ...
    fn: async function(inputs, exits) {
        var nodeArray = await EthereumNode.find({
                status: EthereumNode.constants.status.active
            }),
            nodeToReturn = null;
