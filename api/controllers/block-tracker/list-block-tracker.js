module.exports = {
    friendlyName: "Retrieve list of block trackers based on query and pagination parameters",
    description: "Retrieve list of block trackers based on query and pagination parameters",
    inputs: {
        data: {
            type: {},
            example: {
    ...
    fn: async function(inputs, exits) {
        ...
        try {
            ...
            findPromise = BlockTracker.find(searchCriteria);
